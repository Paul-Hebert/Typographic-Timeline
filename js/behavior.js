...
var data_points = [	
				[	
					...
					["Fraktur",1150,"Fraktur became the most common German blackletter typeface by the mid-16th century. It continued to be used in Germany until the 20th century when its use was forbidden by Adolf Hitler. Its name, derived from the words &ldquo;broken&rdquo; or &ldquo;fractured&rdquo;, implies its form which includes a high degree of &ldquo;breaking,&rdquo; i.e. lines that do not necessarily connect with each other, especially in curved letters.","Germany"]
				],
				[	
					["Humanist",1400,"Humanist typefaces were created during the 15th century by Venetian printers. These typefaces imitated the formal handwriting found in the humanistic (Renaissance) manuscripts of the time. Humanist typefaces are round (in opposition to Blackletter) and are characterized by short and thick bracketed serifs, a slanted cross stroke on the lowercase &lsquo;e&rsquo;, ascenders with slanted serifs, and low contrast between horizontals and verticals. They are still widely used today.",'']
				],
				[	
				...
				[	
					["Italic",1500,"The first italic typeface was produced by Aldus Manutias. Its purpose was to save space in compact &ldquo;pocket&rdquo; books by condensing the width of the letters. Based on humanist cursive script, italics retained the slant of handwriting. Unlike the italic type used today however, early italics had only a modest slope and all capital letters were upright roman letters with no slant.",''],
				...
				[	
					["Aldine",1501,"The typecutter Francesco Griffo created the typeface Aldine for Aldus Manutias&rsquo; 1501 pocketbook edition of the poetry of the Roman poet Virgil. Aldine italic was very popular in its own day and became the model for other italic types. It was widely (and poorly) imitated.","Italy"]
				],
				[	
					["Civilit&eacute;",1557,"The Frenchman Robert Granjon designed the first script typeface, known as civilit&eacute;-letter, in 1557. It was originally used in contracts and includes theatrical flourishes at the end of lines. These gestural strokes resemble the lines written on bank checks to ensure that no additional terms could be added. Civilit&eacute; was also used for devotionals or proclamations.","France"]
				],
				[	
				...
				[	
					["Bodoni",1798,"Considered the first &ldquo;modern&rdquo; typeface, Bodoni was designed by the Italian printer Giambattista Bodoni. The typeface has a pronounced verticality and overall geometric construction that is a dramatic departure from its calligraphic influence. Bodoni&rsquo;s extreme contrast of thick and thin strokes, flat unbracketed serifs, and round dot over the letter &ldquo;i&rdquo; are among its identifying charcteristics.","Italy"]
				],
				[	
					["Slab Serif",1815,"Slab serifs evolved out of the desire for eye-catching display letters for advertising posters and handbills in the early 19th century. The first slab serifed typeface (Antique) was designed by the Englishman Vincent Figgens. Slab serifs are characterized by bold heavy square-cornered serifs (usually without brackets), minimal stress in rounded letters, and little contrast between thick and thin strokes. Slab serifs became known as Egyptian typefaces after Napoleon&rsquo;s conquest of Egypt. Although there was no relationship between Egyptian writing systems and slab serif types, their form does mimic the base and capital of Egytian columns.",'']
				],
				[	
				...
				[	
					["IBM Selectric Typewriter",1961,"The Selectric was known as the carriageless typewriter. It replaced the traditional typewriter&rsquo;s moving carriage with a roller that stayed in position while a typeball and ribbon mechanism moved from side to side eliminating the problem of clashing typebars. It also incorporated word processing and an ability to change fonts which became important features in desktop publishing.","USA"],
					["LetraSet",1961,"LetraSet was a kind of do-it-yourself lettering. You could &ldquo;set&rdquo; your own type by simply positioning a polyethylene sheet of dry transfer lettering with a low tack adhesive over a piece of paper and rubbing it onto the surface below.","England"]
				],
				[	
				...
				[	
					["Portable Computer",1975,"The first portable computer was the IBM 5100 (introduced six years before the first IBM PC). It had 64 KB of RAM, was the size of a small suitcase, and weighed about 55 lbs. The unit included a small keyboard and a 5&rdquo; diagonal CRT display.","USA"]
				],
				[	
				...
				[	
					...
					["PostScript",1984,"PostScript, a page description language which treats type as objects rather than as bit maps, was released by Adobe Systems, Inc. in 1984. Defining lines with B&eacute;zier curves allows letters to be scaleable so they can be used at any size without losing sharpness or quality.","USA"]
				],
				[	
					["Apple Laser Writer",1985,"Apple&rsquo;s first laser printer, the LaserWriter, had Adobe&rsquo;s high quality scalable PostScript fonts built into its memory. In combination with WYSIWYG publishing software like PageMaker the LaserWriter was a key component in the development of desktop publishing.","USA"],
				...
				[	
					...
					["Mashed",1990,"Adobe&rsquo;s 1989 decision to end the encryption of its PostScript fonts coupled with the cut and paste features in software programs such as Fontographer, opened the door for hacking type. Mashed typefaces (or mash-ups) are a patchwork of pre-existing fonts cut and pasted from different sources. Experimental in nature, they were often somewhat crudely executed and intentionally unfinished and imperfect.",''],
					["Dead History",1990,"Designer P. Scott Makela looked to the future, not the past, for inspiration for his typeface Dead History. A manipulation of the vectors of two exiting typefaces Linotype Centennial (a traditional serif) and Adobe&rsquo;s VAG Rounded (a kind of pop classic), Dead History exemplifies the &ldquo;sampling&rdquo; approach to type design that Fontographer made possible. According to him, Dead History &ldquo;personifies a new attitude in type creation . . . the result of the computer&rsquo;s capabilities to function as the perfect assembling tool.","USA"],
					...
					["Web-Safe",1990,"Web-safe fonts are so called &ldquo;resident&rdquo; fonts that come installed on a wide range of computers as part of their operating systems. This guarantees that any content designed using these fonts will be displayed in the same font (on both Macs and PCs) and no substitutions will occurr. Websafe fonts include Andale Mono, Arial, Arial Black, Comic Sans, Courier New, Georgia, Impact, Times New Roman, Trebuchet, Verdana and Wingdings.",""],
					["Beowolf",1990,"Beowolf was designed by Letterror, the Dutch duo of Erik van Blokland and Just van Rossum. It was digitized by hand in Ikarus and then programmed to change at random during printing. It challenged the notion that outline fonts are inherently superior to bitmapped ones and was proof that fonts were no longer physical objects - but rather instructions. The name came from the poem &lsquo;Beowulf&rsquo;, which resists traditional modes of literary criticism because it cannot be treated as a unique, fixed document.","Netherlands"],
					["Interactive",1990,"Interactive typefaces built on the concept of mashed fonts with one important difference – they invited the users themselves to become involved in making changes to their form. Alterations previously the exclusive domain of the types&rsquo; creators were placed in the hands of a wider audience who could make changes at will using computer-based applications.",'']
				],
				[	
					["Blur",1992,"British designer Neville Brody&rsquo;s typeface, Blur, a mutant manipulated type, embraced its own imperfection. Its biomorphic features were created by running Helvetica through Photoshop&rsquo;s blur filter and then vectorizing the results.","UK"]
				],
				[	
					["Walker",1995,"Walker, designed by Matthew Carter, is one of the first interactive and mutable typefaces. It was commissioned as part of the branding system for the Walker Art Center in Minneapolis and is used exclusively by the museum&rsquo;s in-house designers. A sans serif typeface with optional snap on/off serifs for certain letters and a flexible underlining system, Walker represents the diversity of the museum&rsquo;s programming.","USA"]
				],
				[	
					["Verdana",1996,"Matthew Carter&rsquo;s widely used face is regarded as the ultimate example of readability on the web. Designed specifically to be viewed at small sizes on a computer screen, it is characterized by the square dot over the &ldquo;i&rdquo;, lack of serifs, large x-height, wide proportions, loose letter-spacing, large counters, and emphasized distinctions between similarly-shaped characters (such as i, I, and 1) all of which help increase its legibility.","USA"]
				],
				[	
...
var data_point_details_offset = 63;
var you_are_here_offset = 10;

var latest_data_point = [null,null];
...
$(function(){
	draw_timeline();
	add_data_point_markers();

	set_scroll_events();
	set_click_events();

	animate_data_point_container(0);
});
...
function add_data_point_markers(){
	for(i=0; i < data_points.length; i++){
		$('body').append('<div class="data_point_marker">&nbsp;</div> ' + '<span class="data_point_date">' + data_points[i][0][1] + '</span>');

		var data_point_offset = ((data_points[i][0][1] - first_year) * scale) + timeline_offset;
		$('.data_point_marker:last-of-type').css('top', data_point_offset + 'px');
		$('.data_point_date:last-of-type').css('top', data_point_offset - 9 + 'px');

		$('body').append('<div class="data_point_details"><div class="data_point_buttons" id="data_point_buttons_' + i + '"></div></div>');

		for(x=0; x < data_points[i].length; x++){
			$('.data_point_details:last-of-type').css('top', ((data_points[i][x][1] - first_year) * scale) + timeline_offset - data_point_details_offset + 'px');

			$('.data_point_details:last-of-type').append('<div class="data_point_text" id="data_point_' + i + '_' + x + '"><h1>' + data_points[i][x][0] + '</h1><p>' + data_points[i][x][2] + '</p></div>');

			$('.data_point_details:last-of-type .data_point_buttons').append('<div class="button" id="button_' + i + '_' + x + '"  onclick="animate_data_point(' + i + ',' + x + ')">&sect;</div>');

			if (data_points[i][x][3]){
				$('.data_point_details:last-of-type .data_point_text:last-of-type').append('<span>' + data_points[i][x][3] + '</span>')
			}
		}
	}
}
...
function set_scroll_events(){
	$( window ).scroll(function() {
		...
		for(i=0; i < data_points.length; i++){
			if (current_year < data_points[i][0][1] + .5 && current_year > data_points[i][0][1] - .5){
				animate_data_point_container(i);
			}
		}
	});
}

function scroll(target_data_point){
	var scroll_destination = (data_points[target_data_point][0][1] - first_year) * scale;
	$('html, body').animate({
...
function animate_data_point_container(container_num){
	if (latest_data_point[0] !== container_num){
		$('.data_point_buttons').css({'display':'none'});

		if ($('#data_point_buttons_' + container_num + ' .button').length > 1 ){
			$('#data_point_buttons_' + container_num + '').css({'display':'block'});
			$('#data_point_buttons_' + container_num + ' .button').animate({'opacity':'1'},500);
		}

		if (container_num === 0){
			$('#first, #previous').css({'visibility':'hidden'});
		} else if(container_num === data_points.length - 1){
			$('#next, #last').css({'visibility':'hidden'});
		} else{
			$('#first, #previous, #next, #last').css({'visibility':'visible'});
		}

		animate_data_point(container_num,0);
	}
}

function animate_data_point(container_num, data_point_num){
	$('.button').css({'color':'#ccc'});
	$('#button_' + container_num + '_' + data_point_num + '').css({'color':'#f00'});


	$('.data_point_text').css({'display':'none'});
	$('.data_point_text *').css({'opacity':'0'});

	$('#data_point_' + container_num + '_' + data_point_num + '').css({'display':'block'});

	$('#data_point_' + container_num + '_' + data_point_num + ' h1').animate({'opacity':'1'},500);
	$('#data_point_' + container_num + '_' + data_point_num + ' p').animate({'opacity':'1'},1500);
	$('#data_point_' + container_num + '_' + data_point_num + ' span').animate({'opacity':'1'},2000);
	$('#data_point_' + container_num + '_' + data_point_num + ' span').animate({'opacity':'1'},2000);

	latest_data_point = [container_num,data_point_num];
}
